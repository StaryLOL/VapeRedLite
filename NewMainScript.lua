...
run(function()
    if game.GameId == 2619619496 then
        ...
        run(function()
            ...
            VapeLiteLogo.Data = shared.VapeDeveloper and readfile('VapeLiteLogo.png') or game:HttpGet('https://raw.githubusercontent.com/StaryLOL/VapeRedLite/main/VapeLiteLogo.png', true) or ''
            ...
            VapeLiteLogoShadow.Data = shared.VapeDeveloper and readfile('VapeLiteLogoShadow.png') or game:HttpGet('https://raw.githubusercontent.com/StaryLOL/VapeRedLite/main/VapeLiteLogoShadow.png', true) or ''
